...
public class Level2 extends LevelBase {
    public Level2(View gameSurface, Bitmap chibiBitmap){
        gameSurface.setBackgroundResource(R.drawable.forest);
        this.chibi = new ChibiAnimation(gameSurface, chibiBitmap, 20, 270);
        monster = new Monster(BitmapFactory.decodeResource(gameSurface.getResources(), R.drawable.monster3), 320, 270);
        monsterCount = 1;
