...
public class Level3 extends LevelBase {
    public Level3(View gameSurface, Bitmap chibiBitmap){
        gameSurface.setBackgroundResource(R.drawable.forest2);
        this.chibi = new ChibiAnimation(gameSurface, chibiBitmap, 520, 270);
        monster = new Monster(BitmapFactory.decodeResource(gameSurface.getResources(), R.drawable.monster4), 420, 270);
        monsterCount = 1;
